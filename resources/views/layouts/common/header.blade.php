    ...
    <ul class="nav navbar-nav align-items-center ml-auto">
      ...
      <li class="nav-item dropdown dropdown-notification mr-25"><a class="nav-link" href="javascript:void(0);"
        ...
        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
          ...
          <?php if($data->notification_type == "Account") { ?>
            <a class="media d-flex align-items-start" id="{{$data->id}}" href="{{ url('employee-order-list') }}">
              <!-- <a > -->
                ...
                <div class="media-body">
                    ...
                    New order is comming with Order id </span>{{$data->order_id}}</p><small class="notification-text"> Won the monthly best seller badge.</small>

                </div>
              <!-- </a> -->
            </a>
            <?php } else if($data->notification_type == "Account_PO") { ?>
            <a class="media d-flex align-items-start" id="{{$data->id}}" href="{{ url('process-order-list') }}">
              <!-- <a > -->
                <div class="media-left">
                    <div class="avatar bg-light-success">
                        <div class="avatar-content"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check avatar-icon"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
                ...
                <div class="media-body">
                    ...
                    PO is generated by sales team with Order id </span>{{$data->order_id}}</p><small class="notification-text">Please generate invoice for these PO</small>

                </div>
              <!-- </a> -->
            </a>
          <?php } else if($data->notification_type == "Sales") { ?>
            <a class="media d-flex align-items-start" id="{{$data->id}}" href="{{ url('sales-assign-data') }}">
              <!-- <a > -->
                <div class="media-left">
                    <div class="avatar bg-light-success">
                        <div class="avatar-content"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check avatar-icon"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
                ...
                <div class="media-body">
                    ...
                    You have assign new order with Order id </span>{{$data->order_id}}</p> Please generate PO for these order.
            ...
            <?php } else if($data->notification_type == "Manufacturing") { ?>
              ...
              <!-- <a > -->
                ...
                <div class="media-body">
                    <p class="media-heading"><span class="font-weight-bolder">                    
                    New Invoice is generated for Order id </span>{{$data->order_id}}</p>
                </div>
            </a>
            <?php } else if($data->notification_type == "Logistic") { ?>
              <a class="media d-flex align-items-start" id="{{$data->id}}" href="{{ url('process-order-list') }}">
              <!-- <a > -->
                <div class="media-left">
                    <div class="avatar bg-light-success">
                ...
                <div class="media-body">
                    <p class="media-heading"><span class="font-weight-bolder">                    
                    New Invoice generated for Order id </span>{{$data->order_id}}</p>
                </div>
            </a>
            <?php } else if($data->notification_type == "Manufacturing-Revert") { ?>
              <a class="media d-flex align-items-start" id="{{$data->id}}" href="#">
              <!-- <a > -->
                <div class="media-left">
                    <div class="avatar bg-light-success">
                        <div class="avatar-content"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check avatar-icon"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
          ...
          <li class="dropdown-menu-footer" id="read_all"><a class="btn btn-primary btn-block" href="javascript:void(0)">Read all
              notifications</a></li>
        </ul>
      </li>
