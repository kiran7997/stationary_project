            ...
            <a class="media d-flex align-items-start" href="{{ url('sales-assign-data') }}">
              <!-- <a > -->
                ...
                <div class="media-body">
                    <p class="media-heading"><span class="font-weight-bolder">You have assign new order with Order id </span>{{$data->order_id}}</p><small class="notification-text"> Won the monthly best seller badge.</small>
                </div>
              <!-- </a> -->
            </a>
